...
class OsmDataParser:
    ...
    def _parse_rp_node(self, tags, lon, lat, tag_key):
        ...
        if path_tag: #and level_tag != '3':
            ...
            #             if mac not in one_location:
            #                 one_location[mac] = []
            #             one_location[mac].extend(rss_list)
                
            #     for mac in one_location:
            #         if mac == '98:3F:60:34:FB:B0'.lower():
            #             print(f"mac : {mac} {Counter(one_location[mac])}")
